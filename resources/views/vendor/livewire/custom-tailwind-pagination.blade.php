    ...
    @if ($paginator->hasPages())
        <nav role="navigation" aria-label="Pagination Navigation" class="flex items-center justify-between">
            ...
            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                <div class="flex items-center space-x-4 border-right border-gray-200 pr-3 mr-3" style="border-right: 1px solid #e2e8f0; padding-right: 15px; margin-right: auto;">
                    <div class="flex items-center space-x-2">
                        <span class="text-sm text-gray-700 font-medium">Tampilkan:</span>
                        <select wire:model.live="perPage" class="form-select text-sm border-gray-300 rounded-md shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 py-1 px-3 bg-white" style="background-color: #f8f9fa;">
                    ...
                    <p class="text-sm text-gray-700 leading-5 dark:text-gray-400 mb-0" style="margin-bottom: 0;">
