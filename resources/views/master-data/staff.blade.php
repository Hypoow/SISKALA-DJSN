    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                ...
                @include('master-data.partials.tabs', ['active' => 'staff'])
                    ...
                    <div class="col-md-6">
                        <div class="card shadow-sm border-0 rounded-lg overflow-hidden mb-5">
                            <div class="card-header border-0 py-3 px-4"
                                style="background: linear-gradient(87deg, #2dce89 100%) !important;">
                                        ...
                                        <tbody>
                                            @forelse($staffSekretariat as $staff)
                                                <tr class="element-row">
                                                    <td class="pl-4 align-middle font-weight-bold text-secondary">
                                                        {{ $loop->iteration }}</td>
                                                    <td class="align-middle">
                                                        <span
                                                            class="text-sm font-weight-bold text-dark">{{ $staff->name }}</span>
                                                    </td>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                                <a class="dropdown-item" href="javascript:void(0)"
                                                                    onclick="editStaff({{ $staff->id }}, '{{ $staff->name }}', 'sekretariat')">
                                                                    <i class="fe fe-edit-2 mr-2 text-warning"></i> Edit
                                                                </a>
                                                                <form
                                                                    action="{{ route('master-data.staff.destroy', $staff->id) }}"
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="3" class="text-center py-4 text-muted small">Belum ada data
                                                        staf Sekretariat.</td>
                                                </tr>
                                            @endforelse
                                        </tbody>
                                                ...
                                                <tr class="element-row">
                                                    ...
                                                    <td class="align-middle text-right pr-4">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                                <a class="dropdown-item" href="javascript:void(0)"
                                                                    onclick="editStaff({{ $staff->id }}, '{{ $staff->name }}', 'ta')">
                                                                    <i class="fe fe-edit-2 mr-2 text-warning"></i> Edit
                                                                </a>
                                                                <form
                                                                    action="{{ route('master-data.staff.destroy', $staff->id) }}"
            ...
            <div class="modal-content shadow-lg border-0 rounded-xl">
                ...
                <form id="staffForm" method="POST" action="{{ route('master-data.staff.store') }}">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <div class="d-flex">
                                <div class="custom-control custom-radio mb-3 mr-4">
                                    <input name="type" class="custom-control-input" id="typeSekretariat" type="radio"
                                        value="sekretariat" checked>
                    ...
                    <div class="modal-footer bg-white border-top py-3 rounded-bottom-xl d-flex justify-content-between">
                        ...
                        <button type="submit"
                            class="btn btn-primary rounded-pill px-5 shadow-lg border-0 font-weight-bold"><i
                                class="fe fe-save mr-2"></i>Simpan</button>
                    </div>
                </form>
            </div>
        </div>
