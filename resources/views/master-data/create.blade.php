...
@section('title', 'Tambah Akun Baru | Schedulo')
        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Tambah Akun Baru</h6>
            ...
            <div class="card shadow-sm border-0 premium-card">
                <div class="card-header border-0 bg-white pt-4 pb-3">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="mb-0 text-dark"><span class="user-modal-title-icon mr-2 bg-primary-soft text-primary p-2 rounded"><i class="fe fe-user-plus"></i></span> Lengkapi Data Akun</h3>
                            <p class="text-muted text-sm mt-2 mb-0">Atur profil dan hak akses pengguna secara terperinci.</p>
                        </div>
                    </div>
                </div>

                <div class="card-body bg-secondary-soft">
                    <form id="userForm" action="{{ route('master-data.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-lg-10">
                                            ...
                                            <div class="col-md-3 pl-md-2 pr-md-1">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <div class="input-group input-group-merge shadow-sm">
                                                        ...
                                                        <input type="email" class="form-control" id="userEmail" name="email" required placeholder="Alamat Email">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3 pl-md-1">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <div class="input-group input-group-merge shadow-sm">
                                                        ...
                                                        <input type="password" class="form-control" id="userPassword" name="password" required placeholder="Minimal 8 karakter">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-4 pl-md-2">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <div class="input-group input-group-merge shadow-sm">
                                                        ...
                                                        <input type="text" class="form-control" id="userReportTargetLabel" name="report_target_label" placeholder="Cth: Wakil Ketua PME">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-4 pr-md-2">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-control shadow-sm" id="userReceivesDisposition" name="receives_disposition">
                                                        ...
                                                        <option value="0">Tidak, sembunyikan dari checklist disposisi</option>
                                                    </select>
                                            ...
                                            <div class="col-md-4 px-md-1">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <div class="input-group input-group-merge shadow-sm">
                                                        ...
                                                        <input type="text" class="form-control" id="userDispositionGroupLabel" name="disposition_group_label" placeholder="Cth: Sekretariat DJSN">
                                                    </div>
                                                ...
                                                <div class="form-group mb-0">
                                                    <div class="alert alert-light border mb-0">
                                                        <div class="small text-muted">
                                                            <strong class="text-dark d-block mb-2">Rekomendasi jangka panjang</strong>
                                                            Atur default disposisi di data jabatan, lalu gunakan override per akun hanya jika ada pengecualian khusus.
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-lg-4 mb-3">
                                                <label class="role-item h-100 d-flex flex-column p-3 mb-0 rounded-lg shadow-sm border bg-white cursor-pointer position-relative transition-all">
                                                    <input type="radio" name="role" value="{{ $role['value'] }}" class="d-none role-input" required>
                                ...
                                <div class="d-flex justify-content-end mb-5">
                                    <button type="submit" class="btn btn-primary btn-lg rounded-pill shadow px-5">
                                        <i class="fe fe-save mr-2"></i>Simpan Akun
                                    </button>
                                </div>
                            </div>
                        </div>
